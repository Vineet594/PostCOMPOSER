...
const connectDatabase = async () => {
    ...
    const mongoUri = process.env.MONGO_URI || 'mongodb://127.0.0.1:27017/post-composer';
    ...
    try {
        ...
        try {
            console.warn('MongoDB unavailable, starting in-memory server for development...');
            ...
            console.error('MongoDB connection failed:', memoryError);
        }
    }
};
